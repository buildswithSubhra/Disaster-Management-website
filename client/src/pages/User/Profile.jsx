...
import { FaUser, FaEnvelope, FaPhone, FaMapMarkerAlt, FaSave, FaLock, FaCamera } from 'react-icons/fa';
  ...
  return (
    ...
    >
      <motion.div variants={item} className="flex items-start justify-between">
        <div>
          <p className="text-[10px] uppercase tracking-[0.2em] text-gray-400 dark:text-gray-500 font-semibold">Account</p>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-1">My Profile</h1>
      ...
      <motion.div variants={item} className="card">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <FaMapMarkerAlt className="absolute left-3 top-3 text-gray-300 dark:text-gray-600 h-4 w-4" />
              <textarea name="address" value={formData.address} onChange={handleChange} className="input-field pl-10 resize-none" rows="3" />
            </div>
          </div>
          <motion.button
            type="submit"
